# Bundle 7 de exemplo do REDFM (Lote e Validade) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## Example Bundle: Bundle 7 de exemplo do REDFM (Lote e Validade)
...
{
  "resourceType" : "Bundle",
  "id" : "example-redfm-07-lote-validade",
  "identifier" : {
