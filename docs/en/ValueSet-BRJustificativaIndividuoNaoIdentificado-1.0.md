# Justificativa da Impossibilidade de Identificação do Indivíduo (ValueSet) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release
