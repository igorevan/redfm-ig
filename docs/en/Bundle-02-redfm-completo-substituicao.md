# Bundle de exemplo do REDFM (2) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## Example Bundle: Bundle de exemplo do REDFM (2)
  ...
  "entry" : [{
    ...
    "resource" : {
      ...
      "relatesTo" : [{
        "code" : "replaces",
        "targetReference" : {
          "reference" : "Composition/3de5d264-fa69-4fc7-a661-07c916773f94-d1m4"
        }
      }],
      "section" : [{
