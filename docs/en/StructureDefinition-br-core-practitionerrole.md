# BR Core PractitionerRole - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release
...
Other representations of profile: [CSV](../StructureDefinition-br-core-practitionerrole.csv), [Excel](../StructureDefinition-br-core-practitionerrole.xlsx), [Schematron](../StructureDefinition-br-core-practitionerrole.sch) 
