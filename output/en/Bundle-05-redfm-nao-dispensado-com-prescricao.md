# Bundle de exemplo do REDFM (5) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## Example Bundle: Bundle de exemplo do REDFM (5)
...
{
  "resourceType" : "Bundle",
  "id" : "05-redfm-nao-dispensado-com-prescricao",
  "identifier" : {
