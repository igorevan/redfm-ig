# Bundle de exemplo do REDFM (7) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## Example Bundle: Bundle de exemplo do REDFM (7)
...
{
  "resourceType" : "Bundle",
  "id" : "07-redfm-completo-sem-prescricao-fornecedor-nao-farmaceutico",
  "identifier" : {
