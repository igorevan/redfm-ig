# Bundle de exemplo do REDFM (3) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## Example Bundle: Bundle de exemplo do REDFM (3)
...
{
  "resourceType" : "Bundle",
  "id" : "03-redfm-completo-com-prescricao-fornecedor-nao-farmaceutico",
  "identifier" : {
