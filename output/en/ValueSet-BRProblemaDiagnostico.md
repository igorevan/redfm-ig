# Classificação Internacional de Doenças (Atenção Primária) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## ValueSet: Classificação Internacional de Doenças (Atenção Primária) 
...
```json
{
  ...
  "title" : "Classificação Internacional de Doenças (Atenção Primária)",
  "status" : "active",
  "experimental" : false,
