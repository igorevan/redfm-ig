# Bundle de exemplo do REDFM (4) - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release

## Example Bundle: Bundle de exemplo do REDFM (4)
...
{
  "resourceType" : "Bundle",
  "id" : "04-redfm-parcial-com-prescricao-fornecedor-nao-farmaceutico",
  "identifier" : {
