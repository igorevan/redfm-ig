# Unidade de Medida de Medicamento - Guia de Implementação do Registro Eletrônico de Dispensação ou Fornecimento de Medicamento (REDFM) da RNDS v1.0.0-release
...
```json
{
  ...
  "title" : "Unidade de Medida de Medicamento",
  "status" : "active",
  "experimental" : false,
